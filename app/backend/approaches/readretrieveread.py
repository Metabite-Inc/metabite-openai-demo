...
class ReadRetrieveReadApproach(Approach):
    ...
    template_prefix = \
"You are an intelligent Assistant helping the nutrition app service users with their nutrition related questions, taking on the role of a nutritionist. Be brief in your answers. " \
